    ...
    function drawForLine(line, fromArg, toArg) {
      ...
      iterateBidiSections(order, fromArg || 0, toArg == null ? lineLen : toArg, function (from, to, dir, i) {
        ...
        if (toPos.top - fromPos.top <= 3) { // Single line
          ...
          var left$1 = openLeft ? leftSide : (ltr ? fromPos : toPos).left;
          var right = openRight ? rightSide : (ltr ? toPos : fromPos).right;
          var widthAdjust = (openRight && lineObj.wrapClass === "codeblock") ? (-4) : 0;
          add(left$1, fromPos.top, right - left$1 + widthAdjust, fromPos.bottom);
        } else { // Multiple lines
          var topLeft, topRight, botLeft, botRight;
          var widthAdjust$1 = lineObj.wrapClass === "codeblock" ? (-4) : 0;
          ...
          add(topLeft, fromPos.top, topRight - topLeft + widthAdjust$1, fromPos.bottom);
          if (fromPos.bottom < toPos.top) { add(leftSide, fromPos.bottom, rightSide - left + widthAdjust$1, toPos.top); }
          add(botLeft, toPos.top, botRight - botLeft + widthAdjust$1, toPos.bottom);
        }
    ...
    if (sFrom.line == sTo.line) {
      ...
      if (leftEnd.bottom < rightStart.top) {
        ...
        for (var i = sFrom.line + 1; i < sTo.line; i += 1) {
          ...
          var currentValue = extractValue(getLine(doc, i));
          ...
          var left$1 = leftSide + (currentValue ? 4 : 0);
          add(left$1, curTop, rightSide - left$1 - (currentValue ? 4 : 0), bottom);
          curTop = bottom;
        }
      }
    }
