...
(function (global, factory) {
  ...
  var platform = typeof navigator !== "undefined" ? navigator.platform : "Unknown";
  var vendor = typeof navigator !== "undefined" ? navigator.vendor : "Unknown";
  ...
  var hasSelection = getWindow().getSelection ? function (te) {
  ...
  var hasCopyEvent = false;
  if (typeof document !== "undefined") {
    var e$1 = elt("div");
    if ("oncopy" in e$1) {
      hasCopyEvent = true;
    } else {
      e$1.setAttribute("oncopy", "return;");
      hasCopyEvent = typeof e$1.oncopy == "function";
    }
  }
  ...
  function detachMarkedSpans(line, change) {
  ...
  // line's height.
  function updateLine(line, text, markedSpans, estimateHeight, change) {
    line.text = text;
  ...
  function cleanUpLine(line, change) {
    line.parent = null;
    detachMarkedSpans(line, change);
  }
      ...
      if (cm.options.lineNumbers && (!markers || !markers["CodeMirror-linenumbers"]))
        { lineView.lineNumber = gutterWrap.appendChild(
          elt("div", [elt("span", lineNumberFor(cm.options, lineN), "CodeMirror-linenumber-span")],
              "CodeMirror-linenumber linenumber CodeMirror-gutter-elt",
  ...
  function paddingH(display) {
    ...
    var style = getWindow().getComputedStyle ? getWindow().getComputedStyle(e) : e.currentStyle;
  ...
  function estimateLineHeight(cm, lineNumber) {
    var doc = cm.doc, est = estimateHeight(cm);
    var line = getLine(doc, lineNumber);
    var estHeight = est(line);
    if (estHeight != line.height) { updateLineHeight(line, estHeight); }
  }
  ...
  function drawSelectionCursor(cm, head, output) {
    ...
    var cursor = output.appendChild(elt("div", "\u00a0", "CodeMirror-cursor cursor"));
  ...
  function drawSelectionRange(cm, range$$1, output) {
    ...
    function drawForLine(line, fromArg, toArg) {
      ...
      var isCodeBlockLine = isCodeBlockLineObj(lineObj);
      ...
      iterateBidiSections(order, fromArg || 0, toArg == null ? lineLen : toArg, function (from, to, dir, i) {
        ...
        if (toPos.top - fromPos.top <= 3) { // Single line
          ...
          var widthAdjust = (openRight && isCodeBlockLine) ? (-4) : 0;
          add(left, fromPos.top, right - left + widthAdjust, fromPos.bottom);
        } else { // Multiple lines
          var topLeft, topRight, botLeft, botRight;

          var widthAdjust$1 = isCodeBlockLine ? 4 : 0;
          var leftSideToUse = leftSide + widthAdjust$1;
          var rightSideToUse = rightSide - widthAdjust$1;
    ...
    if (sFrom.line == sTo.line) {
      ...
      if (leftEnd.bottom < rightStart.top) {
        var curTop = leftEnd.bottom;
        for (var i = sFrom.line + 1; i < sTo.line; i += 1) {
          var currentValue = isCodeBlockLineObj(getLine(doc, i));
          while (i + 1 < sTo.line && isCodeBlockLineObj(getLine(doc, i + 1)) === currentValue) {
            i += 1;
          }

          var bottom = charCoords(cm, Pos(i, cm.getLine(i).length), "div", getLine(doc, i), "left").bottom;
          var left = leftSide + (currentValue ? 4 : 0);
  ...
  function fireHiddenHandlers(op) {
  ...
  function restoreSelection(snapshot) {
    ...
    if (snapshot.anchorNode && contains(document.body, snapshot.anchorNode) && contains(document.body, snapshot.focusNode)) {
      var sel = getWindow().getSelection(), range$$1 = document.createRange();
  ...
  function updateGutterSpace(display) {
    ...
    display.gutters.style.left = "-" + width + "px";
  }
  ...
  function maybeUpdateLineNumberWidth(cm) {
    ...
    var span = [elt("span", last, "CodeMirror-linenumber-span")];
    if (last.length != display.lineNumChars) {
      var test = display.measure.appendChild(elt("div", [elt("div", span)],
                                                 "CodeMirror-linenumber linenumber CodeMirror-gutter-elt"));
  ...
  function updateDoc(doc, change, markedSpans, estimateHeight$$1) {
    ...
    function update(line, text, spans) {
      updateLine(line, text, spans, estimateHeight$$1, change);
  ...
  LeafChunk.prototype = {
    ...
    removeInner: function(at, n, change) {
  ...
  function addEditorMethods(CodeMirror) {
    ...
    CodeMirror.prototype = {
      ...
      focus: function(){getWindow().focus(); this.display.input.focus();},
  ...
  function findPosV(cm, pos, dir, unit) {
    ...
    if (unit == "page") {
      var pageSize = Math.min(cm.display.wrapper.clientHeight, getWindow().innerHeight || document.documentElement.clientHeight);
